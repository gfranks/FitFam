...
public class GymDatabase {
    ...
    public void saveGym(String userId, FFGym gym) {
    ...
    public void deleteGym(String userId, FFGym gym) {
    ...
    public void isFavorite(String userId, FFGym gym) {
    ...
    public List<FFGym> getAllGyms(String userId) {
        List<FFGym> gyms = new ArrayList<>();
    ...
    private FFGym cursorToGym(Cursor cursor) {
        return new FFGym.Builder()
    ...
    private String getStringFromGeometry(FFGymGeometry geometry) {
    ...
    private FFGymGeometry getGeometryFromString(String value) {
        String[] values = value.split(",");
        FFGymGeometry geometry = new FFGymGeometry();
        FFGymGeometryLocation location = new FFGymGeometryLocation();
