...
public class DiscoverMapRenderer extends DefaultClusterRenderer<FFGym> {
    ...
    public DiscoverMapRenderer(Context context, GoogleMap map, ClusterManager<FFGym> clusterManager) {
    ...
    @Override
    protected void onBeforeClusterRendered(Cluster<FFGym> cluster, MarkerOptions markerOptions) {
    ...
    @Override
    protected void onBeforeClusterItemRendered(FFGym item, MarkerOptions markerOptions) {
