...
public class FFEmptyView extends FrameLayout {
    ...
    public FFEmptyView(Context context) {
        this(context, null);
    }

    public FFEmptyView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FFEmptyView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public FFEmptyView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
