...
public class GymReviewViewHolder extends FFRecyclerView.ViewHolder {
    ...
    public void populate(FFGymReview review) {
    ...
    public void populateAsPlaceHolder(FFGymReview review) {
        populate(review);
