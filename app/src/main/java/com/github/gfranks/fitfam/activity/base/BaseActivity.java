package com.github.gfranks.fitfam.activity.base;
...
import com.github.gfranks.fitfam.module.ActivityModule;
import com.github.gfranks.fitfam.util.Feature;
import com.github.gfranks.fitfam.ui.AppContainer;
import com.github.gfranks.fitfam.ui.AppContainerContentInterface;
...
public class BaseActivity extends AppCompatActivity implements AppContainerContentInterface, AppBarLayout.OnOffsetChangedListener,
    ...
    private ObjectGraph getInjector() {
        if (mActivityGraph == null) {
            mActivityGraph = FitFamApplication.get(this).getApplicationObjectGraph().plus(getModules().toArray());
        }
