...
public class FFGymPhoto implements Parcelable, Type {

    public static final Parcelable.Creator<FFGymPhoto> CREATOR = new Parcelable.Creator<FFGymPhoto>() {
        public FFGymPhoto createFromParcel(Parcel in) {
            return new FFGymPhoto(in);
        }

        public FFGymPhoto[] newArray(int size) {
            return new FFGymPhoto[size];
        }
    };
    ...
    public FFGymPhoto(Parcel in) {
        readFromParcel(in);
    }

    public FFGymPhoto(Builder builder) {
        width = builder.width;
    ...
    public static class Builder {
        ...
        public FFGymPhoto build() {
            return new FFGymPhoto(this);
        }
